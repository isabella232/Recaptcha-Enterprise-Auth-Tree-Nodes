 ...
 * @since AM 5.5.0
 */
public class RecaptchaEnterprisePlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(RecaptchaEnterprisePlugin.currentVersion,
                                        Arrays.asList(RecaptchaEnterpriseProfilerNode.class,
                                                      RecaptchaEnterpriseAssessmentNode.class,
                                                      RecaptchaEnterpriseScoreNode.class,
                                                      RecaptchaEnterpriseReasonCodeNode.class,
                                                      RecaptchaEnterpriseAnnotationNode.class));
    }
    ...
    public String getPluginVersion() {
        return RecaptchaEnterprisePlugin.currentVersion;
    }
}
